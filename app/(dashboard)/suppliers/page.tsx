        ...
        <div className="bg-[var(--dash-bg-raised)] border-b border-[var(--dash-border-default)] px-2 py-3 w-full flex-shrink-0">
          <div className="flex items-center gap-4 overflow-x-auto scrollbar-hide">
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              <span className="text-sm text-[var(--dash-text-muted)] whitespace-nowrap">{filteredSuppliers.length} من {suppliers.length} مورد</span>
            </div>
            ...
            <div className="flex-1 overflow-hidden bg-[var(--dash-bg-surface)]">
              {suppliersLoading ? (
                <div className="flex items-center justify-center h-full">
                  <div className="text-[var(--dash-text-muted)]">جاري تحميل الموردين...</div>
                </div>
              ) : suppliersError ? (
                <div className="flex items-center justify-center h-full">
