...
interface ResizableTableProps {
  ...
  reportType?: 'MAIN_REPORT' | 'PRODUCTS_REPORT' | 'CATEGORIES_REPORT' | 'CUSTOMERS_REPORT' | 'CUSTOMER_INVOICES_REPORT' | 'CUSTOMER_STATEMENT_REPORT' | 'CUSTOMER_INVOICE_DETAILS_REPORT' | 'CUSTOMER_PAYMENTS_REPORT' | 'DAILY_SALES_REPORT' | 'HOURLY_SALES_REPORT' | 'PROFIT_MARGIN_REPORT' | 'SUPPLIER_STATEMENT_REPORT' | 'SUPPLIER_INVOICES_REPORT' | 'SUPPLIER_INVOICE_DETAILS_REPORT' | 'SUPPLIER_PAYMENTS_REPORT' | 'RECORD_STATEMENT_REPORT' | 'RECORD_TRANSACTIONS_REPORT' | 'RECORD_TRANSACTION_DETAILS_REPORT' | 'RECORD_PAYMENTS_REPORT' | 'TRANSFER_INVOICES_REPORT' | 'TRANSFER_ITEMS_REPORT' | 'USERS_REPORT' | 'PAYMENT_METHODS_REPORT' | 'RETURNS_REPORT' | 'PURCHASE_ITEMS_REPORT' | 'PURCHASE_SUPPLIERS_REPORT' | 'PURCHASE_INVOICES_REPORT' | 'CUSTOMER_BALANCES_REPORT' | 'SUPPLIER_BALANCES_REPORT' | 'CASH_DRAWER_REPORT' | 'LOW_STOCK_REPORT' | 'INVENTORY_VALUATION_REPORT' | 'SUPPLIERS_REPORT' | 'INVENTORY_REPORT' | 'EXPENSES_REPORT' | 'POS_PRODUCTS_REPORT' | 'PERMISSIONS_TEMPLATES_REPORT' | 'PERMISSIONS_ROLES_REPORT' // for localStorage key
